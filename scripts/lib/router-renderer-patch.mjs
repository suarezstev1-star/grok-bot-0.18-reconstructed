...
const RRouterProviders=[
  ...
  {value:"claude-code",label:"Claude Code",description:"Use your existing Claude Code sign-in and Grok Bot's connected plugins.",kind:"local",localKey:"claude-code",defaultModel:null},
  {value:"codex",label:"Codex",description:"Use your existing ChatGPT sign-in from Codex with Grok Bot's connected plugins.",kind:"local",localKey:"codex",defaultModel:"gpt-5.4",supportsReasoning:!0},
  {value:"openrouter",label:"OpenRouter",description:"Route through your OpenRouter account and selected model.",kind:"key",secret:"OPENROUTER_API_KEY",defaultModel:"openai/gpt-5.2"}
],RRouterOptions=RRouterProviders.map(s=>({value:s.value,label:s.label})),RRouterReasoningOptions=[{value:"default",label:"Provider default"},{value:"minimal",label:"Minimal"},{value:"low",label:"Low"},{value:"medium",label:"Medium"},{value:"high",label:"High"},{value:"xhigh",label:"Extra high"}],RRouterEmptyUsage={requests:0,inputTokens:0,outputTokens:0,cacheReadTokens:0,cacheWriteTokens:0,lastUsedAt:null},RRouterInputClass="sand-9f619 sand-h8yej3 sand-5f5z56 sand-u97haq sand-lrnmfh sand-uve7l6 sand-16b7oty sand-1rgtt3y sand-o7x2bt sand-mkeg23 sand-1y0btm7 sand-qz0629 sand-1043rbw sand-13l7odt sand-1wd3ewq sand-jb2p0i sand-4z9k3i sand-frs9s4 sand-tt52l0 sand-1odjw0f sand-1t137rt sand-ltfok3";
...
function RRouterModel({provider:s,state:e}){const t=e.models?.providers?.[s.value]??null,[n,r]=de.useState(t?.model??""),[i,o]=de.useState(t?.reasoningEffort??"default"),[l,c]=de.useState(!1),[d,u]=de.useState(null);de.useEffect(()=>{const f=e.models?.providers?.[s.value]??null;r(f?.model??"");o(f?.reasoningEffort??"default")},[s.value,e.models]);const f=async()=>{c(!0);u(null);try{const g=n.trim(),m={provider:s.value,model:g.length===0?null:g};s.supportsReasoning&&(m.reasoningEffort=i==="default"?null:i);const y={...await window.desktop.agent.setInferenceRouter(m),error:null};window.dispatchEvent(new CustomEvent("sand-router-provider-changed",{detail:y}))}catch(g){u(String(g?.message??g))}finally{c(!1)}};return a.jsxs("div",{className:"sand-9f619 sand-78zum5 sand-dt5ytf sand-6s0dn4 sand-h8yej3",style:{gap:8},children:[a.jsxs("div",{className:"sand-9f619 sand-78zum5 sand-6s0dn4 sand-h8yej3",style:{width:360},children:[a.jsx("input",{"aria-label":"Model id",className:RRouterInputClass,disabled:l,onChange:g=>r(g.currentTarget.value),placeholder:s.defaultModel??"Provider default",style:{fontSize:13,height:34,minWidth:0,padding:"0 10px",width:s.supportsReasoning?170:270},type:"text",value:n}),s.supportsReasoning?a.jsx(ye,{"aria-label":"Reasoning effort",onValueChange:g=>{g!==null&&o(g)},options:RRouterReasoningOptions,placement:"bottom-end",size:"sm",value:i,variant:"filled"}):null,a.jsx(oe,{disabled:l,onClick:f,shape:"rectangular",size:"sm",variant:"secondary",children:l?"Saving…":"Save"})]}),d?a.jsx(se,{as:"p",color:"red",size:"sm",children:d}):null]})}
...
function RRouterPanel(){const[s,e]=RRouterState(),[t,n]=RRouterSecrets(),r=RRouterProviders.find(i=>i.value===s.provider)??RRouterProviders[0],i=s.usage?.providers?.[s.provider]??RRouterEmptyUsage,o=r.value==="codex"?"Uses the private ChatGPT login already stored by Codex on this Mac. Requests are made by Grok Bot directly.":r.kind==="local"?"Uses Claude Code's existing login on this Mac.":r.kind==="key"?"Stored securely with your other Grok Bot secrets.":"Uses the account already connected to Grok Bot.",p=r.value==="codex"?"Model and reasoning effort for Codex turns. Leave blank for the Codex default.":r.value==="openrouter"?"OpenRouter model slug for routed turns. Leave blank for the default.":"Claude Code model for routed turns. Leave blank for your CLI login default.";return a.jsx(Te,{children:a.jsxs("div",{className:k("sand-settings-general","sand-9f619 sand-78zum5 sand-dt5ytf sand-3qzy4x"),children:[a.jsx(re,{title:"Routing",children:a.jsx(ie,{description:r.description,label:"Provider",variant:"card",children:a.jsx(ye,{"aria-label":"Routing provider",onValueChange:l=>{if(l!==null)void e(l)},options:RRouterOptions,placement:"bottom-end",size:"lg",value:s.provider,variant:"filled"})})}),a.jsx(re,{title:"Computer",children:a.jsx(RBoxRuntime,{})}),a.jsx(re,{title:r.kind==="key"?"OpenRouter account":"Account",children:a.jsx(ie,{description:o,label:r.kind==="key"?"API key":"Status",variant:"card",children:a.jsx(RRouterCredential,{provider:r,state:s,keys:t,onSaved:n})})}),r.value!=="cursor"?a.jsx(re,{title:"Model",children:a.jsx(ie,{description:p,label:"Model",variant:"card",children:a.jsx(RRouterModel,{provider:r,state:s})})}):null,s.error?a.jsx(se,{as:"p",color:"red",size:"sm",children:s.error}):null,a.jsx(re,{title:"Usage for "+r.label,children:a.jsx(RRouterUsageRows,{usage:i})})]})})}
